...
const features = [
  ...
  "Puanlarını takip et",
  "Ödüllerini takip et",
  "Sadakat programlarına katıl",
  "DOKUN işletmelerini keşfet",
  "Sana özel fırsatları gör",
];
      ...
      <div className="max-w-3xl mx-auto px-4 sm:px-6 text-center">
        <StaggerContainer>
          ...
          <StaggerItem>
            <h2
              id="free-heading"
              className="text-3xl sm:text-4xl lg:text-5xl font-bold text-[#0a0a0a] tracking-tight mb-3"
            >
              DOKUN Club ücretsizdir.
            </h2>
          </StaggerItem>

          <StaggerItem>
            <p className="text-lg text-[#4B5563] mb-10">
              Her özellik, hiçbir ücret. Sadece bir hesap.
            </p>
          </StaggerItem>
          ...
          <StaggerItem>
            <div className="inline-flex items-end gap-2 bg-white border border-[#E5E7EB] rounded-3xl px-8 py-6 mb-10 shadow-sm">
              ...
              <span className="text-lg text-[#9CA3AF] mb-2">/ay</span>
            </div>
          </StaggerItem>
          ...
          <StaggerItem>
            <ul className="grid grid-cols-1 sm:grid-cols-2 gap-3 text-left mb-10 max-w-xl mx-auto">
              {features.map((feature) => (
                <li
                  key={feature}
                  className="flex items-center gap-3 bg-white rounded-2xl px-4 py-3 border border-[#E5E7EB]"
                >
