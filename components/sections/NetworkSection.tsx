...
const demoBusinesses = [
  ...
  },
  {
    initial: "X",
    name: "Barber X",
    campaign: "5 ziyarette 1 ücretsiz",
    badge: "Sadakat",
    color: "#8B5CF6",
  },
  {
    initial: "P",
    name: "Pizza House",
    campaign: "500 puanda büyük pizza",
    badge: "Yeni",
    color: "#EF4444",
  },
  {
    initial: "K",
    name: "Kitap Kafe",
    campaign: "10 kitapta 1 ücretsiz kahve",
    badge: "Özel",
    color: "#3B82F6",
  },
  {
        ...
        <StaggerContainer className="text-center mb-16">
          ...
          <StaggerItem>
            <p className="text-lg text-[#4B5563] max-w-xl mx-auto leading-relaxed">
              DOKUN Club büyüdükçe, DOKUN kullanan işletmeleri keşfedebilir ve
              sana özel fırsatları tek yerden görebilirsin.
            </p>
          </StaggerItem>
          ...
          <StaggerItem>
            <div className="inline-flex items-center gap-2 bg-white border border-[#E5E7EB] rounded-full px-4 py-2 mt-6">
              ...
              <span className="text-xs text-[#6B7280]">
                Demo veriler — gerçek işletmeleri temsil etmez
              </span>
            </div>
          </StaggerItem>
        </StaggerContainer>
          ...
          <StaggerItem>
            <div className="inline-flex items-center gap-3 bg-white border border-[#E5E7EB] rounded-2xl px-6 py-4">
              ...
              <div className="text-sm text-[#4B5563]">
                <span className="font-bold text-[#0a0a0a]">1000+ işletme</span> DOKUN ağına katılıyor
              </div>
            </div>
          </StaggerItem>
        </StaggerContainer>
