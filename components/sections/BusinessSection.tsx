...
const features = [
  ...
  { Icon: Heart, label: "Sadakat" },
  { Icon: BarChart2, label: "Müşteri takibi" },
  { Icon: Target, label: "Kampanyalar" },
  { Icon: MessageCircle, label: "WhatsApp iletişimi" },
  { Icon: TrendingUp, label: "Müşteri analizi" },
];
            ...
            <div className="relative">
              <div className="bg-[#F4FBF7] rounded-3xl p-8 border border-[#16A36A]/10">
                ...
                <div className="bg-white rounded-2xl p-5 border border-[#E5E7EB] shadow-sm mb-4">
                  ...
                  {/* Recent customers — letter avatars */}
          ...
          <StaggerContainer>
            ...
            <StaggerItem>
              <p className="text-lg text-[#4B5563] leading-relaxed mb-8 max-w-md">
                ...
                <span className="font-semibold text-[#0a0a0a]">Onları tekrar getirin.</span>
              </p>
            </StaggerItem>
            ...
            <StaggerItem>
              <p className="mt-4 text-xs text-[#9CA3AF]">
                NFC standı, yazılım ve destek dahil.
              </p>
            </StaggerItem>
          </StaggerContainer>
        </div>
