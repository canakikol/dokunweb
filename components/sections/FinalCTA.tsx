      ...
      <div className="relative max-w-4xl mx-auto px-4 sm:px-6 text-center">
        <SectionWrapper>
          <div className="inline-flex items-center gap-2 bg-white border border-[#16A36A]/20 rounded-full px-4 py-2 mb-8 shadow-sm">
            ...
            <span className="text-xs font-semibold text-[#16A36A]">{c.finalCtaBadge}</span>
          </div>
          ...
          >
            {c.finalCtaTitle1}
            <br />
            <span className="text-[#16A36A]">{c.finalCtaTitle2}</span>
          </h2>

          <p className="text-lg text-[#4B5563] max-w-xl mx-auto mb-10 leading-relaxed">{c.finalCtaDesc}</p>
          ...
          <p className="mt-8 text-sm text-[#9CA3AF]">{c.finalCtaFootnote}</p>
        </SectionWrapper>
      </div>
    </section>
  );
